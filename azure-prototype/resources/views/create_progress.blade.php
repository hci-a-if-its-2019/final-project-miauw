        ...
        function move() {
            ...
            function frame() {
                if (width >= 100) {
                    ...
                    $('.deployment-underway i').css("animation-name","none");
                    $('.deployment-underway i').css("animation-duration","none");
                    $('.deployment-underway i').css("animation-iteration-count","none");
                    $('.deployment-underway i').css("animation-timing-function","none");
